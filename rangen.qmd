...
several years for some definite shortcomings and limitations to emerge.
...
and yet had real-world impact (PCG is the default random generator in numpy).
In the meantime people has devised all sorts of clever techniques to generate
random digits with focus on speed, memory efficiency, and statistical quality
([this](https://prng.di.unimi.it/), e.g., is a good resource).
