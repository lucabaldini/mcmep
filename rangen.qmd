...
go about demonsrtating this. It is even ok if you do not commit to permanent memory
...
does it? As it turns out, this is a well understood fact too, and it depends on
the fact that the modulo we have chosen is a power of the base we are using.
